...
export const getAccessToken = async (clientCredentials: ClientCredentials): Promise<string> => {
...
export const getClient = async (clientCredentials: ClientCredentials): Promise<CommerceLayerClient> => {
