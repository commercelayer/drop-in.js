...
Once you have correctly set up your organization in Commerce Layer and imported the drop-in library as described [here](?path=/docs/getting-started--page), you can use the `cl-availability` component to display an availability message for your products (either available of out-of-stock) with localized delivery lead time and cost, as shown in the code snippets below.
