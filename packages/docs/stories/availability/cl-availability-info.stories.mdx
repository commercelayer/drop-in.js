...
As you saw in the [**cl-availability**](?path=/docs/components-availability-cl-availability--basic) component examples, `cl-availability-info` is a placeholder used to display the availability information in terms of delivery lead times, shipping methods and related cost.
