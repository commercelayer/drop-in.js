...
This component is the owner of the price information. It fetches the price of the specified SKU and dispatches it to the [**cl-price-amount**](?path=/docs/components-price-cl-price-amount--docs) children.
