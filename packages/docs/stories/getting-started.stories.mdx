...
1. Import the library from the [CDN](https://cdn.jsdelivr.net/npm/@commercelayer/drop-in.js@1.1.0-beta.0/dist/drop-in/drop-in.esm.js).
...
```html dark
<script type="module" src="https://cdn.jsdelivr.net/npm/@commercelayer/drop-in.js@1.1.0-beta.0/dist/drop-in/drop-in.esm.js"></script>
...
```html dark
<link href="https://cdn.jsdelivr.net/npm/@commercelayer/drop-in.js@1.1.0-beta.0/dist/drop-in/drop-in.css" rel="stylesheet" />
```
...
```html dark
<link href="https://cdn.jsdelivr.net/npm/@commercelayer/drop-in.js@1.1.0-beta.0/dist/drop-in/minicart.css" rel="stylesheet" />
```
