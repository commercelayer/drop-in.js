...
1. Import the library from the [CDN](https://cdn.jsdelivr.net/npm/@commercelayer/drop-in.js@2.3.0/dist/drop-in/drop-in.esm.js).
...
<script type="module" src="https://cdn.jsdelivr.net/npm/@commercelayer/drop-in.js@2.3.0/dist/drop-in/drop-in.esm.js"></script>
...
<Source language='html' dark code={`
<link href="https://cdn.jsdelivr.net/npm/@commercelayer/drop-in.js@2.3.0/dist/drop-in/drop-in.css" rel="stylesheet" />
`} />
...
<Source language='html' dark code={`
<link href="https://cdn.jsdelivr.net/npm/@commercelayer/drop-in.js@2.3.0/dist/drop-in/minicart.css" rel="stylesheet" />
`} />
