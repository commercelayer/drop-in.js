...
export const argTypes: ArgTypes<Args> = {
  'Use drop-in.css': {
    description: 'Toggle this switch to *simulate* in this page examples how the components would look when importing the `drop-in.css` into your website.',
    control: 'boolean',
    table: {
      category: 'storybook'
    }
  ...
  'Use minicart.css': {
    description: 'Toggle this switch to *simulate* in this page examples how the components would look when importing the `minicart.css` into your website.',
    control: 'boolean',
    table: {
      category: 'storybook',
      disable: true
